...
public class MainPage {
   ...
   // By sortButtonXpath = By.xpath("//*[@class = 'product_sort_container']");
    //By sortContainerXpath = By.xpath("//*[@class = 'active_option']");
    //By addCartXpath = By.xpath("//*[contains(@data-test, \"add-to-cart\")]");
    //By shoppingBoxCart = By.xpath("//*[@class = 'shopping_cart_link']");
    //By cartListOfProducts = By.xpath("//*[@class = 'cart_list']");
